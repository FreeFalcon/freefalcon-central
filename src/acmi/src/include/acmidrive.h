...
public:
    ...
    void StopACMI(void)
    {
        acmiObjectData->StopACMI();
    };
    void PlayACMI(void)
    {
        acmiObjectData->PlayACMI();
    };
    void PlayBackwardsACMI(void)
    {
        acmiObjectData->PlayBackwardsACMI();
    };
    void StepFowardACMI(void)
    {
        acmiObjectData->StepFowardACMI();
    };
    void StepReverseACMI(void)
    {
        acmiObjectData->StepReverseACMI();
    };
    void HomeACMI(void)
    {
        acmiObjectData->HomeACMI();
    };
    void ReverseACMI(void)
    {
        acmiObjectData->ReverseACMI();
    };
    void DirectionACMI(void)
    {
        acmiObjectData->DirectionACMI();
    };
    void FastForwardACMI(void)
    {
    ...
    {
        acmiObjectData->ACMITrackingObject(1);
    };
    void ToggleTracking(void)
    {
        acmiCam->ToggleTracking();
    };
    void AcmiSetElDir(float diff)
    {
        acmiCam->AcmiSetElDir(diff);
    };
    void AcmiSetAzDir(float diff)
    {
        acmiCam->AcmiSetAzDir(diff);
    };
    void AcmiSetObjectEl(float diff)
    {
        acmiCam->AcmiSetObjectEl(diff);
    };
    void AcmiSetObjectAz(float diff)
    {
        acmiCam->AcmiSetObjectAz(diff);
    };
    void AcmiSetPannerAz(void)
    {
    ...
    void AcmiSetSlewRate(float diff)
    {
    ...
    void SetAcmiCameraAction(int currentAction)
    {
    ...
    void IncrementACMICamera(int inc)
    {
        acmiObjectData->ACMICameraObject(inc);
    };
    void IncTrackingACMICamera(int inc)
    {
        acmiObjectData->ACMITrackingObject(inc);
    };
