...
public:
    ...
    void BlitRttTo565(unsigned short* dst, int dstStridePix, int dstHeightPix, int x, int y, int w, int h);
...
protected:
    ...
    BYTE *m_pSysMem;	// PHASE 1/2: RGB565 CPU buffer (GPU composites/presents from it)
    int redShift;
    int greenShift;
    int blueShift;
    DWORD m_dwColorKey;
