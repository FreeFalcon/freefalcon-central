...
public:
    ...
    void SetCurrentSkyColor(Tcolor *rgb)
    {
        CurrentSkyColor = *rgb;
    };
    void GetCurrentSkyColor(Tcolor *rgb)
    {
        *rgb = CurrentSkyColor;
    };
    void GetSkyColor(Tcolor *rgb)
    {
        *rgb = SkyColor;
    };
    void GetHazeSkyColor(Tcolor *rgb)
    {
        *rgb = HazeSkyColor;
    };
    void GetGroundColor(Tcolor *rgb)
    {
        *rgb = GroundColor;
    };
    void GetHazeGroundColor(Tcolor *rgb)
    {
        *rgb = HazeGroundColor;
    };
    void GetTextureLightingColor(Tcolor *rgb)
    {
        *rgb = TextureLighting;
    };
    void GetBadWeatherLighting(Tcolor *rgb)
    {
        *rgb = BadWeatherLighting;
    };
    void GetHazeSunriseColor(Tcolor *rgb)
    {
        *rgb = HazeSunriseColor;
    };
    void GetHazeSunsetColor(Tcolor *rgb)
    {
        *rgb = HazeSunsetColor;
    };
    ...
    Tcolor GetLightningColor()
    {
        return LightningColor;
    };
    int GetTotalTimeOfDay()
    {
        return TotalTimeOfDay;
    };
    int GetTimeOfDay(int i)
    {
        return TimeOfDay[i].Time;
    };
