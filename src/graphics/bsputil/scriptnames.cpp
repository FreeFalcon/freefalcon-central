...
ScriptNameRecord ScriptNameList[] = {
    {"UH1.ANS", 0},       {"Rotate.ANS", 0},   {"AH64.ANS", 1},
    {"Hokum.ANS", 2},     {"OneProp.ANS", 3},  {"C130.ANS", 4},
    {"E3.ANS", 5},        {"VASIF", 6},        {"VASIN", 7},
    {"Chaff.ANS", 8},     {"Beacon.ANS", 9},   {"CHUTEDED.ANS", 10},
    {"LongBow.ANS", 11},  {"Cycle2.ANS", 12},  {"Cycle4.ANS", 13},
    {"Cycle10.ANS", 14},  {"TStrobe.ANS", 15}, {"TU95.ANS", 16},
    {"Meatball.ANS", 17}, {"ComplexProp", 18},
};
...
int GetScriptNumberFromName(char *name)
{
    ...
    printf("Undefined script %s referenced.  Add to Scripts.CPP and "
           "ScriptNames.CPP\n",
           name);
    return -1;
}
