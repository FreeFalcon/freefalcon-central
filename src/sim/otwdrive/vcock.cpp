...
OTWDriverClass::Button3D_Init(int eCPVisType, TCHAR* eCPName, TCHAR* eCPNameNCTR)
{
    ...
    if (eCPVisType == MapVisId(VIS_F16C))
        // RV - Biker
        //sprintf(strCPFile, "%s%s", CockpitTheaterFolder, buttonfile);
        sprintf(strCPFile, "%s\\%s", CockpitTheaterFolder, buttonfile);
    else
    {
        // RV - Biker
        //sprintf(strCPFile, "%s%d\\%s", CockpitTheaterFolder, MapVisId(eCPVisType), vcockfile);
        sprintf(strCPFile, "%s\\%d\\%s", CockpitTheaterFolder, MapVisId(eCPVisType), vcockfile);
        ...
        if (FileExists(strCPFile))
            // RV - Biker
            //sprintf(strCPFile, "%s%d\\%s", CockpitTheaterFolder, MapVisId(eCPVisType), buttonfile);
            sprintf(strCPFile, "%s\\%d\\%s", CockpitTheaterFolder, MapVisId(eCPVisType), buttonfile);
        else
        {
            ...
            // RV - Biker
            //sprintf(strCPFile, "%s%s\\%s", CockpitTheaterFolder, name.c_str(), vcockfile);
            sprintf(strCPFile, "%s\\%s\\%s", CockpitTheaterFolder, name.c_str(), vcockfile);
            ...
            if (FileExists(strCPFile))
                // RV - Biker
                //sprintf(strCPFile, "%s%s\\%s", CockpitTheaterFolder, name.c_str(), buttonfile);
                sprintf(strCPFile, "%s\\%s\\%s", CockpitTheaterFolder, name.c_str(), buttonfile);
            else
            {
                std::string nameNCTR = RemoveInvalidChars(string(eCPNameNCTR, 5));
                // RV - Biker
                //sprintf(strCPFile, "%s%s\\%s", CockpitTheaterFolder, nameNCTR.c_str(), vcockfile);
                sprintf(strCPFile, "%s\\%s\\%s", CockpitTheaterFolder, nameNCTR.c_str(), vcockfile);
                ...
                if (FileExists(strCPFile))
                    // RV - Biker
                    //sprintf(strCPFile, "%s%s\\%s", CockpitTheaterFolder, nameNCTR.c_str(), buttonfile);
                    sprintf(strCPFile, "%s\\%s\\%s", CockpitTheaterFolder, nameNCTR.c_str(), buttonfile);
                else
                {
                    // F16C fallback
