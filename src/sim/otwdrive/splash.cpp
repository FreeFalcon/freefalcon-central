...
void OTWDriverClass::SetupSplashScreen(void)
{
    ...
    if (OTWImage->targetXres() >= 1600)
    {
        ...
        sprintf(filename, "%s\\%s", FalconSplashTheaterFolder, "load16.gif");
        ...
        else
        {
            ...
            sprintf(filename, "%s\\%s", FalconSplashTheaterFolder, "load10.gif");
        }
    }
    else if (OTWImage->targetXres() >= 1280)
    {
        ...
        sprintf(filename, "%s\\%s", FalconSplashTheaterFolder, "load12.gif");
        tmpFile = fopen(filename, "r");
...
void OTWDriverClass::ShowSimpleWaitScreen(char *name)
{
    ...
    sprintf(filename, "%s\\%s16.gif", FalconSplashTheaterFolder, name);
