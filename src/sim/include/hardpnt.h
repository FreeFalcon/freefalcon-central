...
public:
    ...
    {
        pool = MemPoolInitFS(sizeof(BasicWeaponStation), 200, 0);
    };
...
public:
    ...
    virtual DrawableBSP* GetRack(void)
    {
        return NULL;
    };
    ...
    virtual WeaponDomain Domain(void)
    {
        return wdNoDomain;
    };
...
public:
    ...
    static void InitializeStorage()
    {
        pool = MemPoolInitFS(sizeof(AdvancedWeaponStation), 200, 0);
    };
    static void ReleaseStorage()
    {
        MemPoolFree(pool);
...
public:
    ...
    virtual void SetRotation(float a, float e)
    {
        az = a;
        el = e;
    };
    ...
    virtual void GetRotation(float* a, float* e)
    {
        *a = az;
        *e = el;
    };
    virtual void SetSubPosition(int i, float x, float y, float z)
    {
        xSub[i] = x;
        ySub[i] = y;
        zSub[i] = z;
    };
    virtual void SetSubRotation(int i, float a, float e)
    {
        azSub[i] = a;
        elSub[i] = e;
    };
    virtual void GetSubPosition(int i, float* x, float* y, float* z)
    {
        *x = xSub[i];
        *y = ySub[i];
        *z = zSub[i];
    };
    virtual void GetSubRotation(int i, float* a, float* e)
    {
        *a = azSub[i];
        *e = elSub[i];
    };
    ...
    virtual void SetRack(DrawableBSP* rack)
    {
        theRack = rack;
    };
    virtual DrawableBSP* GetPylon(void)
    ...
    virtual void SetPylon(DrawableBSP* Pylon)
    {
        thePylon = Pylon;
    };
    virtual int GetRackId(void)
    ...
    virtual void SetPylonId(int id)
    {
        pylonId = id;
    };
    ...
    virtual void SetWeaponData(WeaponData wd)
    {
        weaponData = wd;
    };
    virtual WeaponType GetWeaponType(void)
    ...
    virtual void SetWeaponType(WeaponType wt)
    {
        weaponType = wt;
    };
    virtual WeaponClass GetWeaponClass(void)
    {
        return weaponData.weaponClass;
    };
    virtual WeaponDomain Domain(void)
    {
        return weaponData.domain;
    };
    virtual void SetWeaponClass(WeaponClass wc)
    {
        weaponData.weaponClass = wc;
    };
    virtual GunClass* GetGun(void)
    {
        return aGun;
    };
    virtual void SetGun(GunClass* gun)
    {
        aGun = gun;
    };
