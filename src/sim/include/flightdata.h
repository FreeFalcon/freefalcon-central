...
#define OSB_STRING_LENGTH                                                      \
    8  // currently strings appear to be max 7 printing chars
...
public:
    enum LightBits
    {
        ...
        OIL =
            0x100, // Right eyebrow; see also HYD (this lamp is not split face)
        ...
        AutoPilotOn =
            0x40000000, // TRUE if is AP on.  NB: This is not a lamp bit!
    ...
    enum LightBits2
    {
        ...
        TFR_ENGAGED =
            0x20000000, // MISC panel; upper half of split face TFR lamp
        GEARHANDLE =
            0x40000000, // Lamp in gear handle lights on fault or gear in motion
    ...
    enum LightBits3
    {
        ...
        Power_Off =
            0x1000, // Set if there is no electrical power.  NB: not a lamp bit
    ...
    float
        speedBrake; // Ownship speed brake position 0 = closed, 1 = 60 Degrees open
    ...
    // landing gear
    float
        NoseGearPos; // Position of the nose landinggear; caution: full down values defined in dat files
    float
        LeftGearPos; // Position of the left landinggear; caution: full down values defined in dat files
    float
        RightGearPos; // Position of the right landinggear; caution: full down values defined in dat files
