...
public:
    ...
    void DrawRttComposite(
        void); // Artscout - 2026: composite THIS MFD's atlas zone onto its 3D panel
    void Exit(void);
...
public:
    ...
    static DrawableClass*
        HadDrawable; // RV - I-Hawk - Added for HAD mode instead of HUDMode
    int Color(void);
