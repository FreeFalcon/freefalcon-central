...
public:
    ...
    {
        ShiAssert(size == sizeof(LineLimiter));
    ...
    {
        pool = MemPoolInitFS(sizeof(LineLimiter), 20, 0);
    };
...
public:
    ...
    void *operator new(size_t size)
    {
        ShiAssert(size == sizeof(ThreePointLimiter));
        return MemAllocFS(pool);
    };
    void operator delete(void *mem)
    {
    ...
    static void InitializeStorage()
    {
        pool = MemPoolInitFS(sizeof(ThreePointLimiter), 20, 0);
    };
    static void ReleaseStorage()
    {
        MemPoolFree(pool);
...
public:
    ...
    void *operator new(size_t size)
    {
        ShiAssert(size == sizeof(ValueLimiter));
        return MemAllocFS(pool);
    };
    void operator delete(void *mem)
    {
    ...
    static void InitializeStorage()
    {
        pool = MemPoolInitFS(sizeof(ValueLimiter), 20, 0);
    };
    static void ReleaseStorage()
    {
        MemPoolFree(pool);
...
public:
    ...
    void *operator new(size_t size)
    {
        ShiAssert(size == sizeof(MinMaxLimiter));
        return MemAllocFS(pool);
    };
    void operator delete(void *mem)
    {
    ...
    static void InitializeStorage()
    {
        pool = MemPoolInitFS(sizeof(MinMaxLimiter), 20, 0);
    };
    static void ReleaseStorage()
    {
        MemPoolFree(pool);
...
public:
    ...
    void *operator new(size_t size)
    {
        ShiAssert(size == sizeof(PercentLimiter));
        return MemAllocFS(pool);
    };
    void operator delete(void *mem)
    {
    ...
    static void InitializeStorage()
    {
        pool = MemPoolInitFS(sizeof(PercentLimiter), 20, 0);
    };
    static void ReleaseStorage()
    {
        MemPoolFree(pool);
