...
struct InputDataDesc
{
    ...
    enum format
    {
        ...
        ID_LOOKUPTABLE,
        ID_2DTABLE
    } type; // what format it is //Cobra 10/30/04 TJL
...
public:
    ...
    bool AssignField(const InputDataDesc *desc, void *dataPtr,
                     const char *value);
};

extern bool AssignField(const InputDataDesc *field, void *dataPtr,
                        const char *value);
extern const InputDataDesc *FindField(const InputDataDesc *desc,
                                      const char *key);
extern bool ParseField(void *dataPtr, const char *line,
                       const InputDataDesc *desc);
extern void Initialise(void *dataPtr, const InputDataDesc *desc);
class SimlibFileClass;
extern bool ParseSimlibFile(void *dataPtr, const InputDataDesc *desc,
