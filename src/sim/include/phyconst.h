...
#define NM_PER_MINUTE                                                          \
    1.00018F //Nautical Mile per Minute of Latitude (Or Longitude at Equator)
#define MINUTE_PER_NM                                                          \
    0.99820F //Minutes of Latitude (or Longitude at Equator) per NM
#define FT_PER_MINUTE                                                          \
    6087.03141F //Feet per Minute of Latitude (Or Longitude at Equator)
#define MINUTE_PER_FT                                                          \
    1.64283E-4F //Minutdes of Latitude (or Longitude at Equator) per foot
