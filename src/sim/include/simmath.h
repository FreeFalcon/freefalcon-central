...
public:
    ...
    SIM_FLOAT DeadBand(SIM_FLOAT input, SIM_FLOAT minBreakout,
                       SIM_FLOAT maxBreakout);
    ...
    SIM_DOUBLE DeadBand(SIM_DOUBLE input, SIM_DOUBLE minBreakout,
                        SIM_DOUBLE maxBreakout);
    ...
    // Tustin Filters
    SIM_FLOAT F1Tust(SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT,
                     SIM_FLOAT, SAVE_ARRAY, SIM_INT *);
    ...
    SIM_FLOAT F4Tust(SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT,
                     SAVE_ARRAY, SIM_INT *);
    SIM_FLOAT F5Tust(SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT,
                     SAVE_ARRAY, SIM_INT *);
    SIM_FLOAT F6Tust(SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SAVE_ARRAY,
                     SIM_INT *);
    SIM_FLOAT F7Tust(SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT,
                     SAVE_ARRAY, SIM_INT *);
    SIM_FLOAT F8Tust(SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT, SIM_FLOAT,
                     SAVE_ARRAY, SIM_INT *);
    ...
    // Interpolators
    SIM_FLOAT OnedInterp(SIM_FLOAT x, const SIM_FLOAT *xarray,
                         const SIM_FLOAT *data, SIM_INT numx, SIM_INT *lastx);
    SIM_FLOAT TwodInterp(SIM_FLOAT x, SIM_FLOAT y, const SIM_FLOAT *xarray,
                         const SIM_FLOAT *yarray, const SIM_FLOAT *data,
                         SIM_INT numx, SIM_INT numy, SIM_INT *lastx,
                         SIM_INT *lasty);
    SIM_FLOAT ThreedInterp(SIM_FLOAT x, SIM_FLOAT y, SIM_FLOAT z,
                           const SIM_FLOAT *xarray, const SIM_FLOAT *yarray,
                           const SIM_FLOAT *zarray, const SIM_FLOAT *data,
                           SIM_INT numx, SIM_INT numy, SIM_INT numz,
