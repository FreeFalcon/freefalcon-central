...
#define SIDC_REMOTE_OWNER                                                      \
    0x02 // We want to create this with a remote machine as owner
...
public:
    ...
    CreateType
        createType; ///< What type/where this entity is being created from
    ...
    Int16
        vehicleInUnit; ///< xth vehicle in a unit - ie: If unit had 15 vehicles, this would be 0-14.
    ...
    Int32
        rwIndex; ///< Runway index (which runway is being used for T/O or landing, if any.
    Int32 start_stalled; ///< Start in a deep stall;
    short weapon[HARDPOINT_MAX]; ///< Weapon ID of each hardpoint - A/C Only
    unsigned char
        weapons[HARDPOINT_MAX]; ///< Weapons on that harpoint - A/C Only
    ...
    Int32
        callsignNum; ///< Flight num of callsign (ie: Viper1/Viper2/Viper3/etc)
