...
public:
    ...
    {
        ShiAssert(size == sizeof(AircraftClass));
    ...
    {
        pool = MemPoolInitFS(sizeof(AircraftClass), 200, 0);
    };
...
public:
    ...
    void SetInstrumentLight(LightSwitch st)
    {
        instrumentLight = st;
    };
    void SetSpotLight(LightSwitch st)
    {
        spotLight = st;
    };
    LightSwitch GetInteriorLight() const
    {
        return interiorLight;
    };
    LightSwitch GetInstrumentLight() const
    {
        return instrumentLight;
    };
    LightSwitch GetSpotLight() const
    {
        return spotLight;
    };
...
public:
    ...
    void ExtlOff(ExtlLightFlags fl)
    {
        ClearAcStatusBits(fl);
    }
    int ExtlState(ExtlLightFlags fl) const
    {
        return (IsAcStatusBitsSet(fl) ? 1 : 0);
    }
    ...
    float GetINSLatDrift(void)
    {
        return (INSLatDrift + INSLatOffset);
    };
    float GetINSLongDrift(void)
    {
        return (INSLongDrift + INSLongOffset);
    };
    float GetINSAltOffset(void)
    {
        return INSAltOffset;
    };
    float GetINSHDGOffset(void)
    {
        return INSHDGOffset;
    };
...
public:
    ...
    void SetMainPower(MainPowerType t)
    {
        mainPower = t;
    };
    void IncMainPower();
    ...
    {
        return (IsAcStatusBitsSet(ACSTATUS_PILOT_EJECTED) ? FALSE : TRUE);
    };
