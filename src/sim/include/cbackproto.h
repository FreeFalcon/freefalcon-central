...
extern void CBEAOA(void *);
extern void CBDAOA(void *);
extern void CBEVVI(void *);
extern void CBDVVI(void *);
...
extern void CBExChaffDispense(void *, int);
extern void CBEChaffDispense(void *, int);
extern void CBExCourseSelect(void *, int);
extern void CBECourseSelect(void *, int);
extern void CBExHeadingSelect(void *, int);
extern void CBEHeadingSelect(void *, int);
extern void CBExFlareDispense(void *, int);
extern void CBEFlareDispense(void *, int);
extern void CBExStoresJettison(void *, int);
extern void CBEStoresJettison(void *, int);
extern void CBExAVTRControl(void *, int);
extern void CBEAVTRControl(void *, int);
extern void CBExModeSelect(void *, int);
extern void CBEModeSelect(void *, int);
extern void CBExMPO(void *, int);
extern void CBEMPO(void *, int);
extern void CBExHornSilencer(void *, int);
extern void CBEHornSilencer(void *, int);

extern void CBExMFDButton(void*, int);
extern void CBEOSB_1L(void *, int);
...
extern void CBExICPPrevious(void *, int);
extern void CBEICPPrevious(void *, int);
extern void CBExICPNext(void *, int);
extern void CBEICPNext(void *, int);
...
extern void CBExICPEnter(void *, int);
extern void CBEICPEnter(void *, int);
...
extern void CBExHUDScales(void *, int);
extern void CBEHUDScales(void *, int);
extern void CBExHUDFPM(void *, int);
extern void CBEHUDFPM(void *, int);
extern void CBExHUDDED(void *, int);
extern void CBEHUDDED(void *, int);
extern void CBExHUDVelocity(void *, int);
extern void CBEHUDVelocity(void *, int);
extern void CBExHUDRadar(void *, int);
extern void CBEHUDRadar(void *, int);
extern void CBExHUDBrightness(void *, int);
extern void CBEHUDBrightness(void *, int);
// 2000-11-10 FUNCTIONS ADDED BY S.G. FOR THE Drift C/O switch
extern void CBExHUDDriftCO(void *, int);
extern void CBEHUDDriftCO(void *, int);
// END OF ADDED FUNCTIONS

extern void CBExECMSwitch(void *, int);
extern void CBEECMSwitch(void *, int);
extern void CBExUHFSwitch(void *, int);
extern void CBEUHFSwitch(void *, int);

extern void CBExEject(void *, int);
extern void CBEEject(void *, int);
extern void CBExLandGearSelect(void *, int);
extern void CBELandGearSelect(void *, int);
extern void CBExAutoPilot(void *, int);
...
extern void CBExAMChaffFlare(void *, int);
extern void CBEAMChaffFlare(void *, int);
...
extern void CBExRALTSwitch(void *, int);
extern void CBERALTSTDBY(void * , int);
extern void CBERALTON(void * , int);
extern void CBERALTOFF(void * , int);
extern void CBERALTSwitch(void * , int);

extern void CBExLandingLightToggle(void *, int);
extern void CBELandingLightToggle(void *, int);
extern void CBExParkingBrakeToggle(void *, int);
extern void CBEParkingBrakeToggle(void *, int);
extern void CBExHookToggle(void *, int);
extern void CBEHookToggle(void *, int); // JB carrier
extern void CBExLaserArmToggle(void *, int);
extern void CBELaserArmToggle(void *, int);
extern void CBExFuelDoorToggle(void *, int);
extern void CBEFuelDoorToggle(void *, int);
extern void CBExRightAPSwitch(void *, int);
extern void CBERightAPSwitch(void *, int);
extern void CBExLeftAPSwitch(void *, int);
extern void CBELeftAPSwitch(void *, int);
extern void CBEAPOverride(void *, int);
extern void CBExWarnReset(void *, int);
extern void CBEWarnReset(void *, int);
extern void CBExReticleSwitch(void *, int);
extern void CBEReticleSwitch(void *, int);
extern void CBEPinkySwitch(void *, int);
extern void CBExGndJettEnable(void *, int);
extern void CBEGndJettEnable(void *, int);
extern void CBExExtlPower(void *, int);
extern void CBEExtlPower(void *, int);
extern void CBExExtlAntiColl(void *, int);
extern void CBEExtlAntiColl(void *, int);
extern void CBExExtlSteady(void *, int);
extern void CBEExtlSteady(void *, int);
extern void CBExExtlWing(void *, int);
extern void CBEExtlWing(void *, int);
extern void CBExAVTRSwitch(void *, int);
extern void CBEAVTRSwitch(void *, int);
extern void CBExIFFPower(void *, int);
extern void CBEIFFPower(void *, int);
extern void CBExINSSwitch(void *, int);
extern void CBEINSSwitch(void *, int);
extern void CBExLEFLockSwitch(void *, int);
extern void CBELEFLockSwitch(void *, int);
extern void CBExDigitalBUP(void *, int);
extern void CBEDigitalBUP(void *, int);
extern void CBExAltFlaps(void *, int);
extern void CBEAltFlaps(void *, int);
extern void CBExManualFlyup(void *, int);
extern void CBEManualFlyup(void *, int);
extern void CBExFLCSReset(void *, int);
extern void CBEFLCSReset(void *, int);
extern void CBExFLTBIT(void *, int);
extern void CBEFLTBIT(void *, int);
extern void CBExOBOGSBit(void *, int);
extern void CBEOBOGSBit(void *, int);
extern void CBExMalIndLights(void *, int);
extern void CBEMalIndLights(void *, int);
extern void CBExProbeHeat(void *, int);
extern void CBEProbeHeat(void *, int);
extern void CBExEPUGEN(void *, int);
extern void CBEEPUGEN(void *, int);
extern void CBExTestSwitch(void *, int);
extern void CBETestSwitch(void *, int);
extern void CBExOverHeat(void *, int);
extern void CBEOverHeat(void *, int);
extern void CBExTrimAPDisc(void *, int);
extern void CBETrimAPDisc(void *, int);
extern void CBExMaxPower(void *, int);
extern void CBEMaxPower(void *, int);
extern void CBExABReset(void *, int);
extern void CBEABReset(void *, int);
extern void CBETrimNose(void *, int);
extern void CBExTrimYaw(void *, int);
extern void CBETrimYaw(void *, int);
extern void CBETrimRoll(void *, int);
extern void CBExMissileVol(void*, int);
...
extern void CBEFCCPower(void *pButton, int);
void CBExMFDPower(void * pButton, int);
extern void CBEMFDPower(void *pButton, int);
void CBExUFCPower(void * pButton, int);
extern void CBEUFCPower(void *pButton, int);
void CBExGPSPower(void * pButton, int);
extern void CBEGPSPower(void *pButton, int);
void CBExDLPower(void * pButton, int);
extern void CBEDLPower(void *pButton, int);
void CBExMAPPower(void * pButton, int);
extern void CBEMAPPower(void *pButton, int);
void CBExRIGHTHPTPower(void * pButton, int);
extern void CBERIGHTHPTPower(void *pButton, int);
void CBExLEFTHPTPower(void * pButton, int);
extern void CBELEFTHPTPower(void *pButton, int);
void CBExTISLPower(void * pButton, int);
extern void CBETISLPower(void *pButton, int);
void CBExHUDPower(void * pButton, int);
extern void CBEHUDPower(void *pButton, int);
void CBExFCRPower(void * pButton, int);
extern void CBEFCRPower(void *pButton, int);
void CBExFuelDisplay(void * pButton, int);
extern void CBEFuelSwitch(void *pButton, int);
void CBExFuelPump(void * pButton, int);
extern void CBEFuelPump(void *pButton, int);
void CBExFuelCock(void * pButton, int);
extern void CBEFuelCock(void *pButton, int);
void CBExFuelExtTrans(void * pButton, int);
extern void CBEFuelExtTrans(void *pButton, int);
void CBExAirSource(void * pButton, int);
extern void CBEAirSource(void *pButton, int);
void CBExInteriorLightSwitch(void * pButton, int);
extern void CBEInteriorLightSwitch(void *pButton, int);
void CBExSeatArmSwitch(void * pButton, int);
extern void CBESeatArmSwitch(void *pButton, int);
void CBExEWSRWRPowerSwitch(void * pButton, int);
extern void CBEEWSRWRPower(void * pButton, int);
void CBExEWSJammerPowerSwitch(void * pButton, int);
extern void CBEEWSJammerPower(void * pButton, int);
void CBExEWSChaffPowerSwitch(void * pButton, int);
extern void CBEEWSChaffPower(void * pButton, int);
void CBExEWSFlarePowerSwitch(void * pButton, int);
extern void CBEEWSFlarePower(void * pButton, int);
void CBExEWSPGMButton(void * pButton, int);
extern void CBEEWSPGMButton(void * pButton, int);
void CBExEWSProgButton(void * pButton, int);
extern void CBEEWSProgButton(void * pButton, int);
void CBExMainPower(void * pButton, int);
extern void CBEMainPower(void *pButton, int);
void CBExInhibitVMS(void * pButton, int);
extern void CBEInhibitVMS(void * pButton, int event);
void CBExRFSwitch(void * pButton, int);
extern void CBERFSwitch(void * pButton, int event);
void CBExHUDColor(void* pButton, int);
extern void CBEHUDColor(void*, int);
void CBExGearHandle(void* pButton, int);
extern void CBEGearHandle(void*, int);
void CBExDeprRet(void* pButton, int);
extern void CBEDeprRet(void*, int);
// JPO
void CBExNwsToggle(void* pButton, int);
extern void CBENwsToggle(void * pButton, int event);
void CBExIdleDetent(void * pButton, int);
extern void CBEIdleDetent(void * pButton, int event);
void CBExInstrumentLightSwitch(void * pButton, int);
extern void CBEInstrumentLightSwitch(void *pButton, int);
void CBExSpotLightSwitch(void * pButton, int);
extern void CBESpotLightSwitch(void *pButton, int);
void CBEFlap(void *pButton, int);
void CBExFlap(void *pButton, int);
void CBELef(void *pButton, int);
void CBExDragChute(void * pButton, int);
extern void CBEDragChute(void *pButton, int);
void CBExCanopy(void * pButton, int);
extern void CBECanopy(void *pButton, int);
