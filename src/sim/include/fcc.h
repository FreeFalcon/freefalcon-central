...
public:
    ...
    FCCMasterMode GetLastMasterMode()
    {
    ...
    */
    FCCMasterMode GetLastNavMasterMode()
    {
        return lastNavMasterMode;
    };
    /*
...
public:
    ...
    void SetDgftSubMode(FCCSubMode dsm)
    {
        dgftSubMode = dsm;
    };
    void SetMrmSubMode(FCCSubMode msm)
    {
        mrmSubMode = msm;
    ...
    int IsNavMasterMode()
    {
        return GetMainMasterMode() == MM_NAV;
    };
    FCCSubMode GetSubMode(void)
    {
        return (subMode);
    };
    FCCSubMode GetDgftSubMode(void)
    {
        return (dgftSubMode);
    };
    ...
    DWORD GetPickleTime(void)
    {
        return PickleTimeToRelease;
    }
