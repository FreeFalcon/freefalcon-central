...
void CBESpeedBreaks(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        ((AircraftClass*)pCPIndicator->mpOwnship)->af->dbrake;
}
...
void CBEFuelFlow(void* pObject)
{
    ...
    else
    {
        ...
        memset(pCPIndicator->mpTapeValues, 0,
               pCPIndicator->mNumTapes * sizeof(float));

        if (len >= pCPIndicator->mNumTapes)
        {
            for (i = 0, j = 2 * pCPIndicator->mNumTapes - len - 1;
                 i <= len - pCPIndicator->mNumTapes; i++, j++)
            {
                pCPIndicator->mpTapeValues[j] = (float)(digitString[i] - 0x30);
            }

            pCPIndicator->mpTapeValues[2] +=
                (float)(digitString[len - 2] - 0x30) * 0.1F;
        }
    }
}
...
void CBEFlapPos(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        ((AircraftClass*)pCPIndicator->mpOwnship)->af->tefPos;
}
...
void CBELEFPos(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        ((AircraftClass*)pCPIndicator->mpOwnship)->af->lefPos;
}
...
void CBERPMTape(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        100.0F * ((AircraftClass*)pCPIndicator->mpOwnship)->af->rpm;
}
...
void CBERPM2Tape(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        100.0F * ((AircraftClass*)pCPIndicator->mpOwnship)->af->rpm2;
}
...
void CBEWingSweepTape(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        (((AircraftClass*)pCPIndicator->mpOwnship)->wingSweep * RTD);
}
...
void CBEFuelFlowLeftTape(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        (((AircraftClass*)pCPIndicator->mpOwnship)->af->GetFuelFlowLeft());
}
...
void CBEFuelFlowRightTape(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        (((AircraftClass*)pCPIndicator->mpOwnship)->af->GetFuelFlowRight());
}
...
void CBEFTITLeftTape(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        (((AircraftClass*)pCPIndicator->mpOwnship)->af->GetFTITLeft());
}
//TJL 09/11/04
void CBEFTITRightTape(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    pCPIndicator->mpTapeValues[0] =
        (((AircraftClass*)pCPIndicator->mpOwnship)->af->GetFTITRight());
}
...
void CBERoundsRemaining(void* pObject)
{
    ...
    pCPIndicator = (CPIndicator*)pObject;
    rounds = (long)((AircraftClass*)pCPIndicator->mpOwnship)
