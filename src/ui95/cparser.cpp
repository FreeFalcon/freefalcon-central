...
void C_Parser::LoadIDTable(char *filename)
{
    ...
    ifp = OpenArtFile(filename, UiArtTheaterFolder, UiArtFolder, 0);
...
void C_Parser::LoadIDList(char *filename)
{
    ...
    strcpy(filebuf, UiArtFolder); // Falcon root
...
#endif
    ifp = OpenArtFile(filename, UiArtTheaterFolder, UiArtFolder);
