...
void C_Parser::LoadIDTable(char *filename)
{
    ...
    ifp = OpenArtFile(filename, FalconUiArtTheaterFolder, FalconUiArtFolder, 0);
...
void C_Parser::LoadIDList(char *filename)
{
    ...
    strcpy(filebuf, FalconUiArtFolder); // Falcon root
...
#endif
    ifp = OpenArtFile(filename, FalconUiArtTheaterFolder, FalconUiArtFolder);
    ...
    while (i < size)
    {
        ...
        if (*lfp)
        {
            if (*lfp != '#')
            {
                //strcpy(filebuf,FalconUiArtFolder);
                //strcat(filebuf,"\\");
                //strcat(filebuf,lfp);
                LoadIDTable(lfp);
            }
...
BOOL C_Parser::LoadSoundList(char *filename)
{
    ...
    while (i < size)
    {
        ...
        {
            char filebuf[_MAX_PATH];
            strcpy(filebuf, FalconUiSoundFolder);
            strcat(filebuf, "\\");
            strcat(filebuf, lfp);
            ParseSound(filebuf);
