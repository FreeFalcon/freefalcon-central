...
public:
    ...
    void SetCluster(long id)
    {
        Section_[_CLUSTER_] = id;
    }
    void SetClient(short client)
    {
        Client_ = client;
    }
    void SetControlFlags(long flags)
    {
        Flags_ = flags;
    }
    ...
    virtual void SetW(long w)
    {
        w_ = w;
    }
    virtual void SetH(long h)
    {
        h_ = h;
    }
    virtual void SetXY(long x, long y)
    {
        x_ = x;
        y_ = y;
    }
    virtual void SetWH(long w, long h)
    {
        w_ = w;
        h_ = h;
    }
    virtual void SetXYWH(long x, long y, long w, long h)
    {
        x_ = x;
        y_ = y;
        w_ = w;
    ...
    */
    virtual BOOL Wheel(int increments, WORD MouseX, WORD MouseY)
    {
        return FALSE;
    }
