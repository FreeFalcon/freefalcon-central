...
public:
    ...
    void SetDragCursorID(long id)
    {
        DragCursor_ = id;
    }
    void SetMenu(long id)
    {
        MenuID_ = id;
    }
    void SetHelpText(long id)
    {
        HelpTextID_ = id;
    }
    ...
    void SetMouseOver(short state)
    {
        MouseOver_ = state;
    }
    void SetMouseOverColor(COLORREF color)
    {
        MouseOverColor_ = color;
    }
    void SetMouseOverPerc(short perc)
    {
        MouseOverPercent_ = perc;
    }
