...
void C_Box::Draw(SCREEN *surface, UI95_RECT *cliprect)
{
    ...
    Parent_->DrawHLine(surface, Color_, GetX(), GetY(), GetW() + 1, GetFlags(),
                       GetClient(), cliprect);
    Parent_->DrawHLine(surface, Color_, GetX(), GetY() + GetH(), GetW() + 1,
                       GetFlags(), GetClient(), cliprect);
    Parent_->DrawVLine(surface, Color_, GetX(), GetY(), GetH() + 1, GetFlags(),
                       GetClient(), cliprect);
    Parent_->DrawVLine(surface, Color_, GetX() + GetW(), GetY(), GetH() + 1,
                       GetFlags(), GetClient(), cliprect);
}
