...
int MissionRequestClass::RequestMission(void)
{
    ...
    if ((TeamInfo[who]) && (TeamInfo[who]->atm) &&
        (TeamInfo[who]->flags & TEAM_ACTIVE))
    {
        ...
        FalconMissionRequestMessage *message = new FalconMissionRequestMessage(
            TeamInfo[who]->atm->Id(), vuLocalSessionEntity);
        GetPriority(this);
...
MissionDataType MissionData[AMIS_OTHER] = {
    ...
    {AMIS_BARCAP,
     ...
     15,
     0,
     AMIS_ADDAWACS | AMIS_NOTHREAT | AMIS_ADDTANKER | AMIS_DONT_COORD |
         AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT | AMIS_FLYALWAYS},
    {AMIS_BARCAP2,
     AMIS_TAR_LOCATION,
     ARO_CA,
     MPROF_HIGH,
    ...
    {AMIS_HAVCAP,
     ...
     15,
     0,
     AMIS_ADDAWACS | AMIS_NOTHREAT | AMIS_ADDTANKER | AMIS_NO_BREAKPT |
         AMIS_FLYALWAYS}, //AMIS_EXPECT_DIVERT | removed, don't divert HAVCAPs
    {AMIS_TARCAP,
     AMIS_TAR_LOCATION,
     ARO_CA,
     MPROF_HIGH,
     ...
     15,
     0,
     AMIS_ADDAWACS | AMIS_HIGHTHREAT | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT |
         AMIS_FLYALWAYS},
    {AMIS_RESCAP,
     AMIS_TAR_LOCATION,
     ARO_CA,
     ...
     15,
     0,
     AMIS_ADDAWACS | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT | AMIS_FLYALWAYS},
    {AMIS_AMBUSHCAP,
     AMIS_TAR_LOCATION,
     ARO_CA,
     MPROF_LOW,
     ...
     15,
     0,
     AMIS_ADDAWACS | AMIS_NOTHREAT | AMIS_DONT_COORD | AMIS_EXPECT_DIVERT |
         AMIS_NO_BREAKPT | AMIS_FLYALWAYS},
    {AMIS_SWEEP,
     AMIS_TAR_LOCATION,
     ARO_CA,
     MPROF_HIGH,
     ...
     30,
     0,
     AMIS_ADDAWACS | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT},
    {AMIS_ALERT,
     AMIS_TAR_LOCATION,
     ARO_CA,
     MPROF_LOW,
     ...
     0,
     0,
     AMIS_NOTHREAT | AMIS_TARGET_ONLY | AMIS_EXPECT_DIVERT | AMIS_NO_BREAKPT |
         AMIS_FLYALWAYS},
    {AMIS_INTERCEPT,
     AMIS_TAR_UNIT,
     ARO_CA,
     ...
     0,
     0,
     AMIS_IMMEDIATE | AMIS_ASSIGNED_TAR | AMIS_EXPECT_DIVERT | AMIS_FLYALWAYS},
    {AMIS_ESCORT,
     AMIS_TAR_UNIT,
     ARO_CA,
     MPROF_STANDARD,
     ...
     0,
     0,
     AMIS_ADDAWACS | AMIS_HIGHTHREAT | AMIS_MATCHSPEED | AMIS_NO_DIST_BONUS |
         AMIS_FLYALWAYS},
    ...
    {AMIS_SEADSTRIKE,
     ...
     255,
     0,
     AMIS_ADDECM | AMIS_ADDBDA | AMIS_AVOIDTHREAT | AMIS_ADDBARCAP |
         AMIS_MATCHSPEED | AMIS_HIGHTHREAT | AMIS_NO_TARGETABORT},
    {AMIS_SEADESCORT,
     AMIS_TAR_UNIT,
     ARO_SEAD,
     MPROF_STANDARD,
     ...
     0,
     0,
     AMIS_ADDECM | AMIS_HIGHTHREAT | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT |
         AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS},
    {AMIS_OCASTRIKE,
     AMIS_TAR_OBJECTIVE,
     ARO_S,
     MPROF_STANDARD,
     ...
     255,
     0,
     AMIS_ADDBDA | AMIS_AVOIDTHREAT | AMIS_ADDSEAD | AMIS_ADDESCORT |
         AMIS_ADDBARCAP | AMIS_ADDOCASTRIKE | AMIS_MATCHSPEED |
         AMIS_NO_TARGETABORT},
    {AMIS_INTSTRIKE,
     AMIS_TAR_OBJECTIVE,
     ARO_S,
     ...
     255,
     0,
     AMIS_ADDBDA | AMIS_AVOIDTHREAT | AMIS_ADDSEAD | AMIS_ADDBARCAP |
         AMIS_ADDOCASTRIKE | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT},
    {AMIS_STRIKE,
     AMIS_TAR_OBJECTIVE,
     ARO_S,
     MPROF_STANDARD,
     ...
     255,
     0,
     AMIS_ADDAWACS | AMIS_ADDBDA | AMIS_AVOIDTHREAT | AMIS_ADDSEAD |
         AMIS_ADDESCORT | AMIS_ADDBARCAP | AMIS_ADDOCASTRIKE | AMIS_MATCHSPEED |
         AMIS_NO_TARGETABORT},
    {AMIS_DEEPSTRIKE,
     AMIS_TAR_OBJECTIVE,
     ARO_S,
     ...
     255,
     0,
     AMIS_ADDAWACS | AMIS_ADDECM | AMIS_AVOIDTHREAT | AMIS_HIGHTHREAT |
         AMIS_ADDSEAD | AMIS_ADDBARCAP | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT},
    {AMIS_STSTRIKE,
     AMIS_TAR_OBJECTIVE,
     ARO_S,
     MPROF_STANDARD,
     ...
     255,
     VEH_STEALTH,
     AMIS_AVOIDTHREAT | AMIS_HIGHTHREAT | AMIS_ADDBARCAP | AMIS_MATCHSPEED |
         AMIS_NO_TARGETABORT},
    {AMIS_STRATBOMB,
     AMIS_TAR_OBJECTIVE,
     ARO_SB,
     ...
     255,
     0,
     AMIS_ADDSEAD | AMIS_ADDESCORT | AMIS_ADDBARCAP | AMIS_ADDOCASTRIKE |
    ...
    {AMIS_FAC,
     ...
     20,
     0,
     AMIS_ADDJSTAR | AMIS_AVOIDTHREAT | AMIS_ADDOCASTRIKE | AMIS_NOTHREAT |
         AMIS_ADDTANKER | AMIS_DONT_COORD | AMIS_NPC_ONLY | AMIS_FLYALWAYS},
    {AMIS_ONCALLCAS,
     AMIS_TAR_LOCATION,
     ARO_GA,
     MPROF_STANDARD,
     ...
     20,
     0,
     AMIS_ADDJSTAR | AMIS_AVOIDTHREAT | AMIS_ADDOCASTRIKE | AMIS_ADDFAC |
         AMIS_ADDBARCAP | AMIS_NOTHREAT | AMIS_ADDTANKER | AMIS_DONT_COORD |
         AMIS_NO_BREAKPT | AMIS_EXPECT_DIVERT | AMIS_FLYALWAYS},
    {AMIS_PRPLANCAS,
     AMIS_TAR_UNIT,
     ARO_GA,
     MPROF_STANDARD,
     ...
     20,
     0,
     AMIS_ADDJSTAR | AMIS_AVOIDTHREAT | AMIS_ADDOCASTRIKE | AMIS_ADDBARCAP |
         AMIS_NOTHREAT | AMIS_NO_TARGETABORT | AMIS_FLYALWAYS},
    {AMIS_CAS,
     AMIS_TAR_LOCATION,
     ARO_GA,
     MPROF_STANDARD,
     ...
     0,
     0,
     AMIS_ADDJSTAR | AMIS_AVOIDTHREAT | AMIS_ADDOCASTRIKE | AMIS_IMMEDIATE |
         AMIS_DONT_COORD | AMIS_ASSIGNED_TAR | AMIS_EXPECT_DIVERT |
         AMIS_FLYALWAYS},
    {AMIS_SAD,
     AMIS_TAR_LOCATION,
     ARO_GA,
     ...
     30,
     0,
     AMIS_ADDAWACS | AMIS_ADDJSTAR | AMIS_ADDBARCAP | AMIS_ADDTANKER |
         AMIS_DONT_COORD | AMIS_NO_BREAKPT},
    {AMIS_INT,
     AMIS_TAR_LOCATION,
     ARO_GA,
     MPROF_STANDARD,
     ...
     30,
     0,
     AMIS_ADDAWACS | AMIS_ADDJSTAR | AMIS_ADDBARCAP | AMIS_DONT_COORD |
         AMIS_NO_BREAKPT},
    {AMIS_BAI,
     AMIS_TAR_LOCATION,
     ARO_GA,
     ...
     30,
     0,
     AMIS_AVOIDTHREAT | AMIS_DONT_COORD | AMIS_NO_BREAKPT},
    {AMIS_AWACS,
     AMIS_TAR_LOCATION,
     ARO_AWACS,
     MPROF_HIGH,
     ...
     120,
     0,
     AMIS_ADDESCORT | AMIS_ADDSWEEP | AMIS_NOTHREAT | AMIS_AIR_LAUNCH_OK |
         AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS},
    {AMIS_JSTAR,
     AMIS_TAR_LOCATION,
     ARO_JSTAR,
    ...
    {AMIS_BDA,
     ...
     0,
     0,
     AMIS_AVOIDTHREAT | AMIS_MATCHSPEED | AMIS_NO_DIST_BONUS},
    {AMIS_ECM,
     AMIS_TAR_LOCATION,
     ARO_ECM,
     MPROF_HIGH,
     ...
     60,
     0,
     AMIS_ADDESCORT | AMIS_ADDSWEEP | AMIS_NOTHREAT | AMIS_NO_DIST_BONUS |
         AMIS_FLYALWAYS},
    {AMIS_AIRCAV,
     AMIS_TAR_UNIT,
     ARO_TACTRANS,
     ...
     0,
     VEH_VTOL,
     AMIS_AVOIDTHREAT | AMIS_ADDSWEEP | AMIS_ADDESCORT | AMIS_MATCHSPEED |
         AMIS_DONT_USE_AC | AMIS_FUDGE_RANGE | AMIS_NO_TARGETABORT |
         AMIS_FLYALWAYS | AMIS_HIGHTHREAT /* KCK: TO ALLOW MORE TO FLY */},
    {AMIS_AIRLIFT,
     AMIS_TAR_LOCATION,
     ARO_TRANS,
     MPROF_HIGH,
     ...
     0,
     0,
     AMIS_NOTHREAT | AMIS_MATCHSPEED | AMIS_DONT_USE_AC | AMIS_AIR_LAUNCH_OK |
         AMIS_NO_TARGETABORT | AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS},
    {AMIS_SAR,
     AMIS_TAR_LOCATION,
     ARO_TACTRANS,
     MPROF_LOW,
     ...
     0,
     VEH_VTOL,
     AMIS_AVOIDTHREAT | AMIS_HIGHTHREAT | AMIS_ADDESCORT | AMIS_ADDBARCAP |
         AMIS_NO_TARGETABORT | AMIS_FLYALWAYS},
    {AMIS_ASW,
     AMIS_TAR_UNIT,
     ARO_ASW,
     MPROF_LOW,
     ...
     0,
     VEH_NAVY,
     AMIS_ADDSWEEP | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT |
         AMIS_NO_DIST_BONUS | AMIS_FLYALWAYS},
    {AMIS_ASHIP,
     AMIS_TAR_UNIT,
     ARO_ASHIP,
     ...
     0,
     0,
     AMIS_ADDESCORT | AMIS_ADDBARCAP | AMIS_MATCHSPEED | AMIS_NO_TARGETABORT |
         AMIS_NO_DIST_BONUS},
    {AMIS_PATROL,
     AMIS_TAR_LOCATION,
     ARO_REC,
     ...
     60,
     VEH_NAVY,
     AMIS_ADDSWEEP | AMIS_MATCHSPEED | AMIS_NO_DIST_BONUS},
    {AMIS_RECONPATROL,
     AMIS_TAR_LOCATION,
     ARO_REC,
     MPROF_LOW,
     ...
     60,
     VEH_VTOL | VEH_ARMY,
     AMIS_ADDSWEEP | AMIS_NPC_ONLY | AMIS_DONT_COORD | AMIS_TARGET_ONLY},
    {AMIS_ABORT,
     AMIS_TAR_LOCATION,
     0,
     MPROF_LOW,
...
void SetupAltitudes(Flight flight, MissionRequestClass *mis)
{
    ...
    if (MissionData[mis->mission].target_profile != TPROF_FLYBY &&
        MissionData[mis->mission].target_profile != TPROF_NONE)
    {
...
void FinalizeWayPoint(WayPoint cw, int reset = FALSE)
{
    ...
    if (sMissionMode > MMODE_TAKEOFF &&
        (cw->GetWPFlags() & WPF_IP || cw->GetWPFlags() & WPF_TARGET ||
         cw->GetWPFlags() & WPF_CP))
    ...
    // Check for Egress
    else if (sMissionMode >= MMODE_IN_TARGET_AREA &&
             sMissionMode < MMODE_EGRESS)
        sMissionMode = MMODE_EGRESS;

    // Check for Post assembly (will be RTB)
    if ((cw->GetWPFlags() & WPF_ASSEMBLE) && sMissionMode >= MMODE_EGRESS &&
        sMissionMode < MMODE_RETURN_TO_BASE)
    {
    ...
    if ((sMissionMode == MMODE_IN_TARGET_AREA && sTargetDesc <= TDESC_TAO) ||
        ((sMissionMode >= MMODE_INGRESS && sMissionMode <= MMODE_EGRESS) &&
         sTargetDesc <= TDESC_ATA) ||
        ((sMissionMode >= MMODE_ENROUTE &&
          sMissionMode <= MMODE_RETURN_TO_BASE) &&
    ...
    if (sMissionMode == MMODE_RETURN_TO_BASE ||
        (sMissionMode > MMODE_TAKEOFF && cw->GetWPAltitude() == 0))
...
WayPoint AddAttackProfile(WayPoint cw, Flight u, MissionRequestClass *mis)
{
    ...
    if (!tpx || !tpy)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            if (s < bs ||
                (s == bs && DistSqu(x, y, bx, by) < DistSqu(tpx, tpy, bx, by)))
            {
                tpx = x;
                tpy = y;
                bs = s;
...
WayPoint AddLoiterProfile(WayPoint cw, Flight u, MissionRequestClass *mis)
{
    ...
    lw = new WayPointClass(
        ...
        MissionData[mis->mission].targetwp, WPF_TARGET | WPF_CP | WPF_REPEAT);
    FinalizeWayPoint(lw);
    cw->InsertWP(lw);
    cw = lw;
...
WayPoint AddLandProfile(WayPoint cw, Flight u, MissionRequestClass *mis)
{
    ...
    tw = new WayPointClass(mis->tx, mis->ty, 0, 0, 0,
                           MissionData[mis->mission].loitertime *
                               CampaignMinutes,
                           MissionData[mis->mission].targetwp,
                           WPF_TARGET | WPF_LAND | WPF_TAKEOFF);
    tw->SetWPTarget(mis->targetID);
    tw->SetWPTargetBuilding((uchar)mis->target_num);
    FinalizeWayPoint(tw);
...
WayPoint AddExitRoute(WayPoint cw, Flight u, MissionRequestClass *mis)
{
    ...
    for (i = 3; i < 7; i++)
    {
        ...
        if (s < bs ||
            (s == bs && DistSqu(x, y, bx, by) < DistSqu(eax, eay, bx, by)))
        {
            eax = x;
            eay = y;
            bs = s;
...
void AddInformationWPs(Flight flight, MissionRequestClass *mis)
{
    ...
    if (o)
    {
        ...
        w = new WayPointClass(x, y, 0, 0, 0, 0, WP_LAND,
                              WPF_ALTERNATE | WPF_LAND | WPF_HOLDCURRENT);
        w->SetWPTarget(o->Id());
        lw->InsertWP(w);
        lw = w;
    }
...
int AddTankerWayPoint(Flight u, int refuel)
{
    ...
    while (lw)
    {
        ...
        if (bw->GetWPAction() == WP_REFUEL &&
            (bw->GetWPFlags() & WPF_REFUEL_INFORMATION))
            bw->DeleteWP();
        ...
        g_bAddIngressWP) // Add a Tanker waypoint at ingress
    {
        ...
        while (lw && lw->GetNextWP())
        {
            ...
            if (::GetOwner(TheCampaign.CampMapData, wx, wy) !=
        ...
        if (ix != 0 && iy != 0) // -> We have found a tanker near a waypoint
        {
            ...
            if (::GetOwner(TheCampaign.CampMapData, wx, wy) != u->GetTeam() &&
                bw->GetPrevWP())
            ...
            else
            {
                ...
                if (::GetOwner(TheCampaign.CampMapData, x, y) != u->GetTeam() &&
                    bw->GetPrevWP())
                    bw = bw->GetPrevWP();
...
long SetWPTimes(Flight u, MissionRequestClass *mis)
{
    ...
    while (w)
    {
        ...
        if (w->GetWPAction() == WP_TAKEOFF || (w->GetWPFlags() & WPF_TARGET) ||
            (w->GetWPFlags() & WPF_ASSEMBLE))
...
// type == false: Egress refuel waypoint
{
    ...
    while (w)
    {
        ...
        if (/*w->GetWPAction() == WP_TAKEOFF ||*/ (
            w->GetWPFlags() &
            WPF_TARGET) /*|| (w->GetWPFlags() & WPF_ASSEMBLE)*/)
            w->SetWPFlag(WPF_TIME_LOCKED);
...
WayPoint EliminateExcessWaypoints(WayPoint w1, WayPoint w2, int who)
{
    ...
    while (w && mw && nw && w != w2 && mw != w2)
    {
        ...
        if (mw->GetWPAction() == WP_NOTHING &&
            !(mw->GetWPFlags() & WPF_CRITICAL_MASK))
        {
...
int CheckPathThreats(Unit u)
{
    ...
    while (w && nw)
    {
        ...
        for (step = 0; step < dist; step += 5)
        {
            ...
            retval |= CollectThreatsFast(
                x, y, GetAltitudeLevel(nw->GetWPAltitude()), u->GetTeam(),
                FIND_NOAIR | FIND_NOMOVERS | FIND_FINDUNSPOTTED, &threats);
                  ...
                  CampaignTime time, long target_flags, short *targeted)
{
    ...
    while (e)
    {
        ...
        if (e->GetAproxCombatStrength(mt, 0) > 0) // This unit can hurt us
        {
            ...
            if (e->IsUnit() && e->GetSType() == STYPE_UNIT_AIR_DEFENSE &&
                (e->GetSpotted(team) || rand() < HALF_CHANCE))
            {
...
// Hash Table version
int TargetThreats(Team team, int priority, FalconPrivateHashTable *list,
                  MoveType mt, CampaignTime time, long target_flags,
                  short *targeted)
{
    CampEntity e;
    int retval = 0, strike_type = 0, do_request;
