...
public:
	...
	int IsRunning (void)									{ return Flags & CAMP_RUNNING; }
	int IsLoaded (void)										{ return Flags & CAMP_LOADED; }
	int IsPreLoaded (void)									{ return Flags & CAMP_PRELOADED; }
	int IsSuspended (void)									{ return Flags & CAMP_SUSPENDED; }
	int IsMaster (void);
	int IsOnline (void)										{ return Flags & CAMP_ONLINE; }
