...
extern int LinkCampaignObjectives(/*BasePathClass **/ Path p, Objective O1,
                                  Objective O2);
...
extern Unit CreateUnit(Control who, int Domain, UnitType Type, uchar SType,
                       uchar SPType, Unit Parent);
