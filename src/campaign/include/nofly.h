...
#define NFZ_OWNER_NOFLY                                                        \
    0 // Only owner team and allies not allowed here (ie: SAM defense zone)
#define NFZ_OVERFLY_ONLY                                                       \
    1 // Only people with overfly privledges allowed (ie country borders)
