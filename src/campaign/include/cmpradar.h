...
#define ALT_FOR_RANGE_DETERMINATION                                            \
    2500.0F // when we return range, it'll be how far we can
...
public:
    float detect_ratio
        [NUM_RADAR_ARCS]; // tan(detection_angle)- basically, ratio of
...
public:
    ...
    {
        return detect_ratio[anum] not_eq 0.0f ?
                   ALT_FOR_RANGE_DETERMINATION / detect_ratio[anum] :
                   0.0f;
    };
