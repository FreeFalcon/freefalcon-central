...
public:
    ...
    {
        assert(size == sizeof(ListElementClass));
    ...
    {
        pool = MemPoolInitFS(sizeof(ListElementClass), 20, 0);
    };
...
public:
    ...
    static void InitializeStorage()
    {
        pool = MemPoolInitFS(sizeof(ListClass), 20, 0);
    };
    static void ReleaseStorage()
    {
        MemPoolFree(pool);
