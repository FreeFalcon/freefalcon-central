...
public:
    ...
    {
        ShiAssert(size == sizeof(BrigadeClass));
    ...
    {
        pool = MemPoolInitFS(sizeof(BrigadeClass), 200, 0);
    };
...
public:
    ...
    uchar GetElements(void)
    {
        return elements;
    }
    uchar GetCElement(void)
    {
        return c_element;
    }
    VU_ID GetElement(int i)
    {
        return element[i];
    }
    short GetFullStrength(void)
    {
        return fullstrength;
    }
