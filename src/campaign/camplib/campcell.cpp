...
void SetReliefType(CellData TheCell, ReliefType NewReliefType)
{
    ...
    *TheCell = (CellDataType)((*TheCell bitand compl ReliefMask) bitor
                              ((Temp << ReliefShift) bitand ReliefMask));
}
...
void SetGroundCover(CellData TheCell, CoverType NewGroundCover)
{
    ...
    *TheCell =
        (CellDataType)((*TheCell bitand compl GroundCoverMask) bitor
                       ((Temp << GroundCoverShift) bitand GroundCoverMask));
}
...
void SetRoadCell(CellData TheCell, char Road)
{
    ...
    *TheCell = (CellDataType)((*TheCell bitand compl RoadMask) bitor
                              ((Temp << RoadShift) bitand RoadMask));
}
...
void SetRailCell(CellData TheCell, char Rail)
{
    ...
    *TheCell = (CellDataType)((*TheCell bitand compl RailMask) bitor
                              ((Temp << RailShift) bitand RailMask));
}
