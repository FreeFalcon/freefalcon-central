...
struct OLD_ASCII_TABLE Old_Key_Chart[256] = {
    ...
    {'-', '_', _IS_ASCII_ | _IS_DIGIT_,
     _IS_ASCII_}, // DIK_MINUS           0x0C    /* - on main keyboard */
    {'=', '+', _IS_ASCII_ | _IS_DIGIT_, _IS_ASCII_}, // DIK_EQUALS          0x0D
    {0, 0, 0, 0}, // DIK_BACK            0x0E    /* backspace */
    {0, 0, 0, 0}, // DIK_TAB             0x0F
    {'q', 'Q', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_Q               0x10
    {'w', 'W', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_W               0x11
    {'e', 'E', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_E               0x12
    {'r', 'R', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_R               0x13
    {'t', 'T', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_T               0x14
    {'y', 'Y', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_Y               0x15
    {'u', 'U', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_U               0x16
    {'i', 'I', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_I               0x17
    {'o', 'O', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_O               0x18
    {'p', 'P', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_P               0x19
    ...
    {'a', 'A', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_A               0x1E
    {'s', 'S', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_S               0x1F
    {'d', 'D', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_D               0x20
    {'f', 'F', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_F               0x21
    {'g', 'G', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_G               0x22
    {'h', 'H', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_H               0x23
    {'j', 'J', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_J               0x24
    {'k', 'K', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_K               0x25
    {'l', 'L', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_L               0x26
    {';', ':', _IS_ASCII_, _IS_ASCII_}, // DIK_SEMICOLON       0x27
    {'\'', '"', _IS_ASCII_, _IS_ASCII_}, // DIK_APOSTROPHE      0x28
    {'`', '~', _IS_ASCII_,
     _IS_ASCII_}, // DIK_GRAVE           0x29    /* accent grave */
    {0, 0, 0, 0}, // DIK_LSHIFT          0x2A
    {'/', '|', _IS_ASCII_, _IS_ASCII_}, // DIK_BACKSLASH       0x2B
    {'z', 'Z', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_Z               0x2C
    {'x', 'X', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_X               0x2D
    {'c', 'C', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_C               0x2E
    {'v', 'V', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_V               0x2F
    {'b', 'B', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_B               0x30
    {'n', 'N', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_N               0x31
    {'m', 'M', _IS_ASCII_ | _IS_ALPHA_,
     _IS_ASCII_ | _IS_ALPHA_}, // DIK_M               0x32
    {',', '<', _IS_ASCII_, _IS_ASCII_}, // DIK_COMMA           0x33
    {'.', '>', _IS_ASCII_,
     _IS_ASCII_}, // DIK_PERIOD          0x34    /* . on main keyboard */
    {'/', '?', _IS_ASCII_,
     _IS_ASCII_}, // DIK_SLASH           0x35    /* / on main keyboard */
    {0, 0, 0, 0}, // DIK_RSHIFT          0x36
    {'*', 0, _IS_ASCII_,
     _IS_ASCII_}, // DIK_MULTIPLY        0x37    /* * on numeric keypad */
    ...
    {0, '=', 0,
     _IS_ASCII_}, // DIK_NUMPADEQUALS    0x8D    /* = on numeric keypad (NEC PC98) */
    {0, 0, 0, 0}, // 0 (Space holder)    0x8E
    {0, 0, 0, 0}, // 0 (Space holder)    0x8F
    {0, 0, 0,
     0}, // DIK_CIRCUMFLEX      0x90    /* (Japanese keyboard)            */
    {0, '@', 0,
     _IS_ASCII_}, // DIK_AT              0x91    /*                     (NEC PC98) */
    {0, ':', 0,
     _IS_ASCII_}, // DIK_COLON           0x92    /*                     (NEC PC98) */
    {0, '_', 0,
     _IS_ASCII_}, // DIK_UNDERLINE       0x93    /*                     (NEC PC98) */
    {0, 0, 0,
    ...
    {0, ',', 0,
     _IS_ASCII_}, // DIK_NUMPADCOMMA     0xB3    /* , on numeric keypad (NEC PC98) */
    {0, 0, 0, 0}, // 0 (Space holder)    0xB4
    {0, '/', 0,
     _IS_ASCII_}, // DIK_DIVIDE          0xB5    /* / on numeric keypad */
...
void main(int argc, char **argv)
{
    ...
    if (argc < 3)
    {
        ...
        printf("    <input file> - a list of DIK_KEY codes to override default "
               "english ascii set\n");
        printf("      record format:  DIK_KEY_VALUE    ASCII_VALUE      "
               "SHIFT_STATES      ASCII_FLAGS\n");
        printf("      where: DIK_KEY_VALUE is a number from 1 to 255\n");
        printf("             ASCII_VALUE is the index in the font for the "
               "character you need printed\n");
        printf("             SHIFT_STATES are any combination of SHIFT, ALT, "
               "CTRL\n");
        printf(
            "                          each separated ba at least a space\n");
        printf("             ASCII_FLAGS  if the Ascii character is a number "
               "put DIGIT on the line\n");
        printf("                          if the ascii character is part of "
               "the alphabet put ALPHA on the line\n");
        printf("Examples:\n");
        printf("40                196     SHIFT   ALPHA    <- this would be "
               "the line for the 'a' with the '\"' over it\n");
        printf("DIK_APOSTROPHE    196     SHIFT   ALPHA    <- this would be "
               "the line for the 'a' with the '\"' over it\n");
        printf("16      64      CTRL ALT    <- this would be the line for the "
               "'@' on the german keyboard\n");
        printf("DIK_Q   64      CTRL ALT    <- this would be the line for the "
               "'@' on the german keyboard\n\n");
        printf("    <output files> - This program will spit out 2 files...\n");
        printf("             1st file   <output>.h   - a text file you can "
               "look at to see if everything is ok\n");
        printf("             2nd file   <output>.bin - data file loaded into "
               "the game\n\n");
            ...
            if (token)
            {
                ...
                if (Index)
                {
                    ...
                    if (ascii)
                    {
                        ...
                        Key_Chart[Index].Flags[shiftstates] =
                            _IS_ASCII_ | AsciiFlags;
                    }
                }
            }
        }
    ...
    if (fp)
    {
        ...
        for (i = 0; i < 256; i++)
        {
            ...
            for (j = 0; j < 8; j++)
                fprintf(fp, "%c ",
                        (Key_Chart[i].Flags[j] & _IS_ASCII_ ?
                             Key_Chart[i].Ascii[j] :
                             ' '));
