...
int __stdcall AddClientDV(LPDVINFO lpDVInfo)
{
    ...
    __try
    {
        __try
        {
            ...
            if ((NULL == lpDVInfo) ||
                (TRUE == IsBadCodePtr((FARPROC)lpDVInfo->pfnDump)) ||
            ...
            if (0 == g_dwDVCount)
            {
                ...
                g_pstDVInfo = (LPDVINFO)HeapAlloc(
                    g_hHeap, HEAP_GENERATE_EXCEPTIONS | HEAP_ZERO_MEMORY,
                    sizeof(DVINFO));
            ...
            else if (0 != CLIENT_BLOCK_SUBTYPE(lpDVInfo->dwValue))
            {
                ...
                lpDV = (LPDVINFO)bsearch(lpDVInfo, g_pstDVInfo, g_dwDVCount,
                                         sizeof(DVINFO),
            ...
            g_pstDVInfo = (LPDVINFO)HeapReAlloc(
                g_hHeap, HEAP_GENERATE_EXCEPTIONS | HEAP_ZERO_MEMORY,
            ...
            else
            {
                ...
                DWORD dwDest =
                    (DWORD)g_pstDVInfo + ((iCurr + 1) * sizeof(DVINFO));
...
static BOOL CheckMaxSubType()
{
    ...
    {
        _RPT0(_CRT_WARN, "Running max subtype value in "
...
static LPDVINFO FindRegisteredBlockType(void* pData)
{
    ...
    lpDV = (LPDVINFO)bsearch(&stDVFind, g_pstDVInfo, g_dwDVCount,
                             sizeof(DVINFO), (PFNCOMPARE)CompareDVInfos);
    return (lpDV);
}
