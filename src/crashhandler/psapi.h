...
extern "C"
{
    ...
    DWORD
    WINAPI
    GetModuleBaseNameA(HANDLE hProcess, HMODULE hModule, LPSTR lpBaseName,
                       DWORD nSize);

    DWORD
    WINAPI
    GetModuleBaseNameW(HANDLE hProcess, HMODULE hModule, LPWSTR lpBaseName,
                       DWORD nSize);
...
#define GetModuleBaseName GetModuleBaseNameA
    ...
    DWORD
    WINAPI
    GetModuleFileNameExA(HANDLE hProcess, HMODULE hModule, LPSTR lpFilename,
                         DWORD nSize);

    DWORD
    WINAPI
    GetModuleFileNameExW(HANDLE hProcess, HMODULE hModule, LPWSTR lpFilename,
                         DWORD nSize);
...
#define GetModuleFileNameEx GetModuleFileNameExA
    ...
    DWORD
    WINAPI
    GetMappedFileNameW(HANDLE hProcess, LPVOID lpv, LPWSTR lpFilename,
                       DWORD nSize);

    DWORD
    WINAPI
    GetMappedFileNameA(HANDLE hProcess, LPVOID lpv, LPSTR lpFilename,
                       DWORD nSize);
...
#define GetMappedFilenameEx GetMappedFilenameExA
    ...
    BOOL WINAPI EnumDeviceDrivers(LPVOID *lpImageBase, DWORD cb,
                                  LPDWORD lpcbNeeded);
