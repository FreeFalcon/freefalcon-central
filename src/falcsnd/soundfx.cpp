...
SFX_DEF_ENTRY BuiltinSFX[] = {
    ...
    {"biggun1.wav", 0, 0, 0, 10000000.0F, 0.0F, -10000.0F, 10000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_EXTERN bitor SFX_FLAGS_3D, 1.0F, 1.0F,
     FX_SOUND_GROUP, 0, 0},
    ...
    {"engheli.wav", 0, 0, 0, 10000000.0F, 0.0F, -6000.0F, 10000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_POS_EXTERN bitor
         SFX_FLAGS_FREQ bitor SFX_FLAGS_3D bitor SFX_FLAGS_HIGH,
     1.0F, 1.0F, ENGINE_SOUND_GROUP, 0, 0},
    {"eject.wav", 0, 0, 0, 100000.0F, 0.0F, -10000.0F, 100000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_EXTERN bitor SFX_FLAGS_3D, 1.0F, 1.0F,
     FX_SOUND_GROUP, 0, 0},
    {"growl.wav", 0, 0, 0, 100000.0F, 0.0F, -10000.0F, 1000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_FLAGS_FREQ bitor
         SFX_FLAGS_HIGH,
     1.0F, 1.0F, SIDEWINDER_SOUND_GROUP, 0, 0},
    {"growlock.wav", 0, 0, 0, 4000000.0F, 0.0F, -10000.0F, 4000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_FLAGS_FREQ, 1.0F, 1.0F,
     SIDEWINDER_SOUND_GROUP, 0, 0},
    ...
    {"prop.wav", 0, 0, 0, 500000.0F, 0.0F, -10000.0F, 500000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_POS_EXTERN bitor
         SFX_FLAGS_FREQ bitor SFX_FLAGS_3D,
     1.0F, 1.0F, ENGINE_SOUND_GROUP, 0, 0},
    ...
    {"vulloop.wav", 0, 0, 0, 400000000.0F, 0.0F, -4000.0F, 400000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_FLAGS_3D, 1.0F, 1.0F,
     COCKPIT_SOUND_GROUP, 0, 0},
    ...
    {"enginea.wav", 0, 0, 0, 2500000000.0F, 0.0F, -100.0F, 2500000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_POS_EXTERN bitor
         SFX_FLAGS_FREQ bitor SFX_FLAGS_3D bitor SFX_FLAGS_HIGH,
     1.0F, 1.0F, ENGINE_SOUND_GROUP, 0, 500},
    ...
    {"f16int.wav", 0, 0, 0, 2500000000.0F, 0.0F, -10000.0F, 2500000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_FLAGS_FREQ bitor
         SFX_FLAGS_3D bitor SFX_FLAGS_HIGH,
     1.0F, 1.0F, ENGINE_SOUND_GROUP, 0, 500},
    {"twi/mig21.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL, 1.0F, 1.0F, RWR_SOUND_GROUP, 2, 3},
    ...
    {"burnere.wav", 0, 0, 0, 2500000000.0F, 0.0F, -100.0F, 2500000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_POS_EXTERN bitor
         SFX_FLAGS_FREQ bitor SFX_FLAGS_3D bitor SFX_FLAGS_HIGH,
     1.0F, 1.0F, ENGINE_SOUND_GROUP, 0, 500},
    {"burneri.wav", 0, 0, 0, 2500000000.0F, 0.0F, -10000.0F, 2500000000.0F, 0,
     0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_FLAGS_FREQ bitor
         SFX_FLAGS_3D bitor SFX_FLAGS_HIGH,
     1.0F, 1.0F, ENGINE_SOUND_GROUP, 0, 500},
    {"twi/mig23.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL, 1.0F, 1.0F, RWR_SOUND_GROUP, 2, 2},
    {"touchdn.wav", 0, 0, 0, 10000000.0F, 0.0F, -10000.0F, 10000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_EXTERN bitor SFX_FLAGS_3D, 1.0F, 1.0F,
     ENGINE_SOUND_GROUP, 0, 0},
    ...
    {"vulloope.wav", 0, 0, 0, 5000000.0F, 0.0F, -10000.0F, 5000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_POS_EXTERN bitor
         SFX_FLAGS_3D,
     1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    ...
    {"twi/chaparal.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     0},
    ...
    {"twi/adats.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 6},
    ...
    {"twi/hercules.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     7},
    ...
    {"twi/launch.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 0, 0},
    {"twi/lav_adv.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 9},
    {"twi/patriot.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 8},
    ...
    {"twi/slotback.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 2,
     1},
    ...
    {"fireloop.wav", 0, 0, 0, 50000000.0F, -500.0F, -10000.0F, 50000000.0F, 0,
     0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_POS_EXTERN bitor
         SFX_FLAGS_3D bitor SFX_FLAGS_FREQ,
     1.0F, 1.0F, FX_SOUND_GROUP, 0, 0},
    ...
    {"impactg6.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_EXTERN bitor SFX_FLAGS_3D, 1.0F, 1.0F,
     FX_SOUND_GROUP, 0, 0},
    {"cockpit/toggllil.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/chngview.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/ejectlvr.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/geardwn.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/gearup.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/icp1.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/ICP2.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/icpmntry.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/jettison.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/knobbig.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/knoblil.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/mfd.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/momntary.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/navknob.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/togglbig.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"cockpit/chaflare.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    ...
    {"gearoend.wav", 0, 0, 0, 5000000.0F, 0.0F, -10000.0F, 5000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_EXTERN bitor SFX_FLAGS_3D, 1.0F, 1.0F,
     ENGINE_SOUND_GROUP, 0, 0},
    {"cockpit/ugh.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"twi/Barlock.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 1, 9},
    {"twi/Firecan.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 1, 3},
    {"twi/flatface.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 1,
     1},
    {"twi/longtrak.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 1,
     5},
    {"twi/lowblow.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 1, 6},
    {"twi/MPQ54.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 0},
    {"twi/MSQ48.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 3},
    {"twi/MSQ50.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/spoonrst.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 1,
     7},
    {"twi/Tps63.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     10},
    ...
    {"twi/spy1a.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 5},
    {"twi/gundish.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 1, 8},
    {"twi/amraam.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 8, 1},
    {"twi/phoenix.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 8, 2},
    {"cockpit/lspdtone.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F,
     400000000.0F, 0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F,
     COCKPIT_SOUND_GROUP, 0, 0},
    {"tlscrape.wav", 0, 0, 0, 4000000.0F, 0.0F, -10000.0F, 4000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_FLAGS_3D bitor
         SFX_FLAGS_FREQ,
     1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    ...
    {"thump2.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_FLAGS_3D bitor SFX_FLAGS_FREQ, 1.0F, 1.0F,
     FX_SOUND_GROUP, 0, 0},
    {"TireSqueal.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0,
     SFX_POSITIONAL bitor SFX_POS_LOOPED bitor SFX_FLAGS_3D bitor
         SFX_FLAGS_FREQ,
     1.0F, 1.0F, FX_SOUND_GROUP, 0, 0},
    ...
    {"hit5.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_FLAGS_3D bitor SFX_FLAGS_FREQ, 1.0F, 1.0F,
     FX_SOUND_GROUP, 0, 0},
    {"GroundCrunch.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_EXTERN bitor SFX_FLAGS_3D, 1.0F, 1.0F,
     FX_SOUND_GROUP, 0, 0},
    {"c130.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_POS_EXTERN bitor SFX_FLAGS_FREQ bitor
         SFX_FLAGS_3D bitor SFX_FLAGS_HIGH,
     1.0F, 1.0F, ENGINE_SOUND_GROUP, 0, 0},
    ...
    {"Chaflare.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0, 0,
     SFX_POSITIONAL bitor SFX_FLAGS_VMS, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0, 0},
    {"Chaflarelow.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_FLAGS_VMS, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0,
     0},
    {"Chaflareout.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_FLAGS_VMS, 1.0F, 1.0F, COCKPIT_SOUND_GROUP, 0,
     0},
    ...
    {"twi/FLATLIB.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/TOMBSTONE.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/CLAMSHELL.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/BIGBIRD.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/SQUATEYE.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/TALLKING.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/SIDENET.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/BACKNET.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/KNIFEREST.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/GRILLPAN.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/BILLBOARD.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/HIGHSCREEN.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/ODDPAIR.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/PATHAND.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/THINSKIN.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/TINSHIELD.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/GINSLING.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/FLAPWHEEL.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"twi/DOGEAR.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/BIGBACK.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
    {"twi/BACKTRAP.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F,
     0, 0, SFX_POSITIONAL bitor SFX_POS_LOOPED, 1.0F, 1.0F, RWR_SOUND_GROUP, 5,
     4},
    {"mikeclick.wav", 0, 0, 0, 400000000.0F, 0.0F, -10000.0F, 400000000.0F, 0,
     0, SFX_POSITIONAL, 1.0F, 1.0F, RWR_SOUND_GROUP, 5, 4},
