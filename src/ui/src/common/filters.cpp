...
{
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_AIRBORNE, _UNIT_COMBAT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_AIRMOBILE, _UNIT_COMBAT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_AIR_DEFENSE, _UNIT_AIR_DEFENSE bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_ARMOR, _UNIT_COMBAT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_ARMORED_CAV, _UNIT_COMBAT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_ENGINEER, _UNIT_SUPPORT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_HQ, _UNIT_SUPPORT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_INFANTRY, _UNIT_COMBAT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_MARINE, _UNIT_COMBAT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_MECHANIZED, _UNIT_COMBAT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_ROCKET, _UNIT_SUPPORT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_SP_ARTILLERY, _UNIT_SUPPORT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_SS_MISSILE, _UNIT_SUPPORT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_SUPPLY, _UNIT_SUPPORT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BATTALION, STYPE_UNIT_TOWED_ARTILLERY, _UNIT_SUPPORT bitor _UNIT_BATTALION, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_AIRBORNE, _UNIT_COMBAT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_AIRMOBILE, _UNIT_COMBAT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_AIR_DEFENSE, _UNIT_AIR_DEFENSE bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_ARMOR, _UNIT_COMBAT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_ARMORED_CAV, _UNIT_COMBAT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_ENGINEER, _UNIT_SUPPORT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_HQ, _UNIT_SUPPORT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_INFANTRY, _UNIT_COMBAT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_MARINE, _UNIT_COMBAT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_MECHANIZED, _UNIT_COMBAT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_ROCKET, _UNIT_SUPPORT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_SP_ARTILLERY, _UNIT_SUPPORT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_SS_MISSILE, _UNIT_SUPPORT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_SUPPLY, _UNIT_SUPPORT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_LAND, CLASS_UNIT, TYPE_BRIGADE, STYPE_UNIT_TOWED_ARTILLERY, _UNIT_SUPPORT bitor _UNIT_BRIGADE, OOB_ARMY},
    { DOMAIN_SEA, CLASS_UNIT, TYPE_TASKFORCE, STYPE_UNIT_AMPHIBIOUS, _UNIT_COMBAT bitor _UNIT_NAVAL, OOB_NAVY},
    { DOMAIN_SEA, CLASS_UNIT, TYPE_TASKFORCE, STYPE_UNIT_CARRIER, _UNIT_COMBAT bitor _UNIT_NAVAL, OOB_NAVY},
    { DOMAIN_SEA, CLASS_UNIT, TYPE_TASKFORCE, STYPE_UNIT_CRUISER, _UNIT_COMBAT bitor _UNIT_NAVAL, OOB_NAVY},
    { DOMAIN_SEA, CLASS_UNIT, TYPE_TASKFORCE, STYPE_UNIT_DESTROYER, _UNIT_COMBAT bitor _UNIT_NAVAL, OOB_NAVY},
    { DOMAIN_SEA, CLASS_UNIT, TYPE_TASKFORCE, STYPE_UNIT_FRIGATE, _UNIT_COMBAT bitor _UNIT_NAVAL, OOB_NAVY},
    { DOMAIN_SEA, CLASS_UNIT, TYPE_TASKFORCE, STYPE_UNIT_PATROL, _UNIT_COMBAT bitor _UNIT_NAVAL, OOB_NAVY},
    { DOMAIN_SEA, CLASS_UNIT, TYPE_TASKFORCE, STYPE_UNIT_SEA_SUPPLY, _UNIT_SUPPORT bitor _UNIT_NAVAL, OOB_NAVY},
    { DOMAIN_SEA, CLASS_UNIT, TYPE_TASKFORCE, STYPE_UNIT_SEA_TANKER, _UNIT_SUPPORT bitor _UNIT_NAVAL, OOB_NAVY},
...
long FindDivisionType(uchar type)
{
    ...
    while (UnitFilters[i].UIType)
    {
        if (type == (UnitFilters[i].SubType bitand 0x00ffffff))
            return((UnitFilters[i].UIType bitand 0x00ffffff) bitor _UNIT_DIVISION);
