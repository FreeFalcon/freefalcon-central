...
public:
    ...
    void SetObjectiveMenu(long ID)
    {
        ObjectiveMenu_ = ID;
    }
    void SetUnitMenu(long ID)
    {
        UnitMenu_ = ID;
    }
    void SetWaypointMenu(long ID)
    {
        WaypointMenu_ = ID;
    }
    void SetSquadronMenu(long ID)
    {
        SquadronMenu_ = ID;
    }
    void SetMissionMenu(long ID)
    {
        MissionMenu_ = ID;
    }
