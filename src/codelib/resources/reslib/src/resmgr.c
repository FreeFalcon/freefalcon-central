...
/* =======================================================
   ...
   ======================================================= */
// Pu239 01/20/2013
// As the original author said, MS has a version of this file 
// and apparently it is now in the library LIBCMTD.lib, however
// VS2010 doesn't complain about it in most of cases, that's why 
// we can still get pass the compilation. I used some minimum code
// to investigate the source of the problem why fopen() is not 
// working, and then VS2010 complained in the linking process! 
// (G! Finally). So when the source of the issue is clear, the
// rest of the work is easy...
// However, please don't ask me why this is happening, or why the
// code below doesn't work, I have been working on this bug for 
// more than 24 hours now, I really didn't looking into the code
// I commented out.
