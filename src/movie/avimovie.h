...
#define MOVIE_PRELOAD_AUDIO 2     // load the entire audio file
    ...
    */
    ...
    extern int movieOpen(char *aviFileName, char *audioFileName,
                         LPVOID ddSurface, int callBackID,
                         void (*callBack)(int handle, LPVOID ddSurface,
                                          int frameNumber, int callBackID,
                                          int dropFlag, SURFACEACCESS *sa),
