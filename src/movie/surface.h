...
#define SURFACE_IS_LOCKED 1
    ...
    extern void surfaceGetPointer(LPVOID, SURFACEACCESS *);
    extern void surfaceReleasePointer(LPVOID, SURFACEACCESS *);
    extern void surfaceGetDescription(LPVOID, SURFACEDESCRIPTION *);
    extern LPVOID surfaceCreate(LPVOID, int, int);
    extern void surfaceRelease(LPVOID);
    extern int surfaceBlit(LPVOID, int, int, LPVOID, int, int, int);
