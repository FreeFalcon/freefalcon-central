...
public:
    ...
    void SetTeam(C_ListBox *lbox)
    {
        Team_ = lbox;
    }
    void SetAction(C_ListBox *lbox)
    {
        Action_ = lbox;
    }
    void SetTarget(C_Button *btn)
    {
        Target_ = btn;
    }
    void SetArgs(C_ListBox *lbox)
    {
        Args_ = lbox;
    }
    void SetPoints(C_EditBox *ebox)
    {
        Points_ = ebox;
    }
    ...
    void SetColors(COLORREF off, COLORREF on, COLORREF done)
    {
        Color_[0] = off;
        Color_[1] = on;
        Color_[2] = done;
