...
public:
    ...
    void SetInfoBg(short x, short y, short w, short h)
    {
        InfoBg_.left = x;
        InfoBg_.top = y;
        InfoBg_.right = w;
    ...
    void SetName(short x, short y, _TCHAR *str)
    {
        if (Name_)
        {
            Name_->SetXY(x, y);
    ...
    void SetPilots(short x, short y, _TCHAR *str)
    {
        if (Pilots_)
        {
            Pilots_->SetXY(x, y);
    ...
    void SetPlayers(short x, short y, _TCHAR *str)
    {
        if (Players_)
        {
            Players_->SetXY(x, y);
            Players_->SetText(str);
            Players_->SetInfo();
        }
    }
    ...
    void SetInfoBgColor(COLORREF Off, COLORREF On)
    {
        InfoBgColor_[0] = Off;
        InfoBgColor_[1] = On;
    }
    ...
    void SetNumVehicles(short i)
    {
        NumVehicles_ = i;
    }
    void SetNumPilots(short i)
    {
        NumPilots_ = i;
    }
    void SetNumPlayers(short i)
    {
        NumPlayers_ = i;
    }
