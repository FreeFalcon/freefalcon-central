...
public:
    ...
    void SetName(short x, short y, TCHAR *str)
    {
        if (Name_)
        {
            Name_->SetXY(x, y);
    ...
    void SetStatus(short x, short y, long ImageID)
    {
        if (Status_)
        {
            Status_->SetXY(x, y);
            Status_->SetImage(ImageID);
            Status_->SetInfo();
        }
    }
    void SetStatus(short x, short y, IMAGE_RSC *Image)
    {
        if (Status_)
        {
            Status_->SetXY(x, y);
