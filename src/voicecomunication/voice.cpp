...
bool stoppingvoice = false;		// global from the original Voice.cpp (extern'd in F4Comms)

//-----------------------------------------------------------------------------
// No-op implementations of the public API (see voicecom.h).
//-----------------------------------------------------------------------------
HRESULT WINAPI DirectPlayMessageHandler(PVOID, DWORD, PVOID)        { return S_OK; }
HRESULT WINAPI LobbyAppMessageHandler(PVOID, DWORD, PVOID)          { return S_OK; }
HRESULT WINAPI DirectVoiceServerMessageHandler(PVOID, DWORD, PVOID) { return S_OK; }
HRESULT WINAPI DirectVoiceClientMessageHandler(PVOID, DWORD, PVOID) { return S_OK; }

BOOL    IsServiceProviderValid(const GUID*)  { return FALSE; }
void    StopVoice()                          {}
HRESULT InitDirectPlay()                     { return S_OK; }
HRESULT InitDirectPlayVoice()                { return S_OK; }
HRESULT CreateDeviceAddress()                { return S_OK; }
HRESULT CreateHostAddress(WCHAR*)            { return S_OK; }
HRESULT HostSession()                        { return S_OK; }
HRESULT EnumDirectPlayHosts(char*)           { return S_OK; }
HRESULT ConnectToSession()                   { return S_OK; }
HRESULT SendDirectPlayMessage()              { return S_OK; }
HRESULT Register()                           { return S_OK; }
HRESULT UnRegister()                         { return S_OK; }
HRESULT LobbyLaunch()                        { return S_OK; }
HRESULT TestDirectVoice()                    { return S_OK; }
HWND    GetConsoleHwnd()                     { return NULL; }
void    CleanupDirectPlay()                  {}
int     main(char*)                          { return 0; }
