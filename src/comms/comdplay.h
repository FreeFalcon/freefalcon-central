...
typedef HRESULT(PASCAL FAR *DPFN_DirectPlayCreate)(LPGUID lpGUID,
                                                   LPDIRECTPLAY *lplpDP,
                                                   IUnknown *pUnk);
#ifdef UNICODE
typedef HRESULT(PASCAL FAR *DPFN_DirectPlayEnumerate)(LPDPENUMDPCALLBACK,
                                                      LPVOID);
typedef HRESULT(PASCAL FAR *DPFN_DirectPlayLobbyCreate)(LPGUID,
                                                        LPDIRECTPLAYLOBBY *,
                                                        IUnknown *, LPVOID,
                                                        DWORD);
#else
typedef HRESULT(PASCAL FAR *DPFN_DirectPlayEnumerate)(LPDPENUMDPCALLBACKA,
                                                      LPVOID);
typedef HRESULT(PASCAL FAR *DPFN_DirectPlayLobbyCreate)(LPGUID,
                                                        LPDIRECTPLAYLOBBYA *,
                                                        IUnknown *, LPVOID,
...
typedef HRESULT(PASCAL FAR *OLEFN_CoCreateInstance)(REFCLSID rclsid,
                                                    LPUNKNOWN pUnkOuter,
                                                    DWORD dwClsContext,
                                                    REFIID riid,
                                                    LPVOID FAR *ppv);
