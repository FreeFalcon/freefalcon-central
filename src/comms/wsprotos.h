...
typedef int(PASCAL FAR *WSFN_bind)(SOCKET s, const struct sockaddr FAR *addr,
                                   int namelen);

typedef int(PASCAL FAR *WSFN_closesocket)(SOCKET s);

typedef int(PASCAL FAR *WSFN_connect)(SOCKET s, const struct sockaddr FAR *name,
                                      int namelen);
...
typedef int(PASCAL FAR *WSFN_recvfrom)(SOCKET s, char FAR *buf, int len,
                                       int flags, struct sockaddr FAR *from,
                                       int FAR *fromlen);

typedef int(PASCAL FAR *WSFN_select)(int nfds, fd_set FAR *readfds,
                                     fd_set FAR *writefds,
                                     fd_set FAR *exceptfds,
                                     const struct timeval FAR *timeout);

typedef int(PASCAL FAR *WSFN_send)(SOCKET s, const char FAR *buf, int len,
                                   int flags);

typedef int(PASCAL FAR *WSFN_sendto)(SOCKET s, const char FAR *buf, int len,
