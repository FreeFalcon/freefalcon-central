...
int wing1, wing2, wing3, wing4, wing5, wing6, wing7, wing8, wing10, sent6,
    sent7, sent8, sent9, sent10, tower1, tower2, tower3, tower4, tower5;
...
{
    static int delay_wing1 = 0, delay_wing3 = 0, delay_wing8 = 0,
               delay_wing10 = 0, delay_sent8 = 0, delay_sent9 = 0,
               delay_sent10 = 0, delay_tower1 = 0, delay_tower3 = 0,
               idle_before = FALSE;
    ...
    if ((delay_wing1) && (now > delay_wing1))
    {
        F4PlaySound(wing1);
        delay_wing1 = 0;
    }

    if ((delay_wing3) && (now > delay_wing3))
    {
        F4PlaySound(wing3);
        delay_wing3 = 0;
    }

    if ((delay_wing8) && (now > delay_wing8))
    {
        F4PlaySound(wing8);
        delay_wing8 = 0;
    }

    if ((delay_wing10) && (now > delay_wing10))
    {
        F4PlaySound(wing10);
        delay_wing10 = 0;
    }

    if ((delay_sent8) && (now > delay_sent8))
    {
        F4PlaySound(sent8);
        delay_sent8 = 0;
    }

    if ((delay_sent9) && (now > delay_sent9))
    {
        F4PlaySound(sent9);
        delay_sent9 = 0;
    }

    if ((delay_sent10) && (now > delay_sent10))
    {
        F4PlaySound(sent10);
        delay_sent10 = 0;
    }

    if ((delay_tower1) && (now > delay_tower1))
    {
        F4PlaySound(tower1);
        delay_tower1 = 0;
    }

    if ((delay_tower3) && (now > delay_tower3))
    {
        F4PlaySound(tower3);
        delay_tower3 = 0;
    }
