...
FalconTeamMessage::FalconTeamMessage(VU_ID entityId, VuTargetEntity *target,
                                     VU_BOOL loopback)
    : FalconEvent(TeamMsg, FalconEvent::CampaignThread, entityId, target,
                  loopback)
{
}

FalconTeamMessage::FalconTeamMessage(VU_MSG_TYPE type, VU_ID senderid,
                                     VU_ID target)
    : FalconEvent(TeamMsg, FalconEvent::CampaignThread, senderid, target)
{
    type;
}
