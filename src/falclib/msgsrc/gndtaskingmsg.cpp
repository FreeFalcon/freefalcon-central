...
FalconGndTaskingMessage::FalconGndTaskingMessage(VU_ID entityId,
                                                 VuTargetEntity *target,
                                                 VU_BOOL loopback)
    : FalconEvent(GndTaskingMsg, FalconEvent::CampaignThread, entityId, target,
                  loopback)
{
    // Your Code Goes Here
}

FalconGndTaskingMessage::FalconGndTaskingMessage(VU_MSG_TYPE type,
                                                 VU_ID senderid, VU_ID target)
    : FalconEvent(GndTaskingMsg, FalconEvent::CampaignThread, senderid, target)
{
    // Your Code Goes Here
}
