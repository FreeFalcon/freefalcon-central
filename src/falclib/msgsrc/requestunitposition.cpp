...
RequestUnitPosition::RequestUnitPosition(SimMoverClass *mover, VU_ID target)
    : FalconEvent(RequestUnitPositionMsg, FalconEvent::SimThread, mover->Id(),
                  static_cast<VuTargetEntity *>(vuDatabase->Find(target)),
                  FALSE)
{
...
RequestUnitPosition::RequestUnitPosition(VU_ID senderID, VU_ID targetID)
    : FalconEvent(RequestUnitPositionMsg, FalconEvent::SimThread, senderID,
                  targetID)
{
}
