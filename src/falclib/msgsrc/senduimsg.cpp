...
UISendMsg::UISendMsg(VU_ID entityId, VuTargetEntity *target, VU_BOOL loopback)
    : FalconEvent(SendUIMsg, FalconEvent::SimThread, entityId, target, loopback)
{
    // Your Code Goes Here
}

UISendMsg::UISendMsg(VU_MSG_TYPE type, VU_ID senderid, VU_ID target)
    : FalconEvent(SendUIMsg, FalconEvent::SimThread, senderid, target)
{
    // Your Code Goes Here
    type;
}
