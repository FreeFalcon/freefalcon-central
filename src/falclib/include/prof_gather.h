...
#else
// Artscout - 2026 (Linux port): POSIX profiler primitives.
    ...
    Prof_dummy_declare(                                                        \
      ...
      /* check the cached Zone_Stack and update if needed */                 \
        (Prof_cache->parent not_eq Prof_stack ?                                \
             ...
             0),                                                               \
                                                                               \
        ++Prof_cache->total_entry_count, Prof_get_timestamp(&Prof_time),       \
                                                                               \
      ...
      /* start the timer on this stack */                                    \
        Prof_stack->t_self_start = Prof_time, 0)
...
inline Prof_Scope_Var::Prof_Scope_Var(Prof_Zone &zone,
                                      Prof_Zone_Stack *&Prof_cache)
{
