...
public:
    ...
    // accessors
    _TCHAR* GetPlayerName(void)
    {
        return name;
    }
    _TCHAR* GetPlayerCallsign(void)
    {
        return callSign;
    }
    VU_ID GetPlayerSquadronID(void) const
    {
        return playerSquadron;
    }
    VU_ID GetPlayerFlightID(void) const
    {
        return playerFlight;
    }
    VU_ID GetPlayerEntityID(void) const
    {
        return playerEntity;
    }
    // sfr: changed to FalconEntity
    //VuEntityEntity* GetPlayerEntity(void) const     { return playerEntityPtr.get(); }
    FalconEntity* GetPlayerEntity(void) const
    {
        return playerEntityPtr.get();
    }
    FlightClass* GetPlayerFlight(void) const
    {
    ...
    uchar GetAircraftNum(void) const
    {
        return aircraftNum;
    }
    uchar GetPilotSlot(void) const
    {
        return pilotSlot;
    }
    uchar GetFlyState(void) const
    {
        return flyState;
    }
    short GetReqCompression(void) const
    {
        return reqCompression;
    }
    float GetBubbleRatio(void) const
    {
        return bubbleRatio;
    }
    ...
    uchar GetVoiceID() const
    {
        return voiceID;
    }
    FalconGameEntity* GetGame(void)
    {
        return (FalconGameEntity*)VuSessionEntity::Game();
    }

    uchar GetAssignedAircraftNum(void) const
    {
        return assignedAircraftNum;
    }
    uchar GetAssignedPilotSlot(void) const
    {
        return assignedPilotSlot;
    }
    FlightClass* GetAssignedPlayerFlight(void) const
    {
    ...
    void SetVuStateAccess(VU_MEM state)
    {
        SetVuState(state);
    }
    void SetBubbleRatio(float ratio)
    {
        bubbleRatio = ratio;
    }
    ...
    void SetRating(uchar newrat)
    {
        rating = newrat;
    }
    void SetVoiceID(uchar v)
    {
        voiceID = v;
    }
