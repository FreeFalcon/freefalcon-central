...
VuGridIterator::VuGridIterator(VuGridTree *coll, BIG_SCALAR p1, BIG_SCALAR p2,
                               BIG_SCALAR radius)
    : p1_(p1), p2_(p2), radius_(radius),
      it_(static_cast<VuRedBlackTree *>(NULL)), VuIterator(coll)
{
    // sfr: temp test
    //static int temp = 1;
    //radius *= temp;
