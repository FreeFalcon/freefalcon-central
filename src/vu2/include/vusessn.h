...
public:
    ...
    VuCommsConnectStatus GetCommsStatus()
    {
    ...
    void SetCommsStatus(VuCommsConnectStatus cs)
    {
    ...
    void SetReliableCommsStatus(VuCommsConnectStatus cs)
    {
...
public:
    ...
    //sfr: converts
    //ip port info
    void SetAddress(VU_ADDRESS add)
    {
        address_ = add;
    }
    void SetCallsign(const char *callsign);
    void SetLoadMetric(VU_BYTE newMetric)
    {
    ...
    void SetLastMessageReceived(int id)
    {
        lastMsgRecvd_ = id;
    }
    ...
    VU_BYTE TimeSyncState()
    {
        return timeSyncState_;
    }
    VU_TIME Latency()
    {
        return latency_;
...
public:
    ...
    int SessionCount()
    {
        return sessionCollection_->Count();
    }

    // setters
    void SetGroupName(char *groupname);
    void SetMaxSessions(ushort max)
    {
        sessionMax_ = max;
    }
...
public:
    ...
    void SetConnected(VU_BOOL conn)
    {
        connected_ = conn;
    }
