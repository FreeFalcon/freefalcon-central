...
public:
    ...
    VU_BYTE Domain() const
    {
        return domain_;
    }
    // check VuFlagBits for descriptions of each flag bit
    VU_BOOL IsPrivate() const
    {
        return (VU_BOOL)share_.flags_.breakdown_.private_;
    }
    VU_BOOL IsTransferrable() const
    {
        return (VU_BOOL)share_.flags_.breakdown_.transfer_;
    }
    VU_BOOL IsTangible() const
    {
        return (VU_BOOL)share_.flags_.breakdown_.tangible_;
    }
    VU_BOOL IsCollidable() const
    {
        return (VU_BOOL)share_.flags_.breakdown_.collidable_;
    }
    VU_BOOL IsGlobal() const
    {
        return (VU_BOOL)share_.flags_.breakdown_.global_;
    }
    VU_BOOL IsPersistent() const
    {
        return (VU_BOOL)share_.flags_.breakdown_.persistent_;
    }
    ...
    {
        return static_cast<VU_SEND_TYPE>(share_.flags_.breakdown_.sendCreate_);
    }
    void SetSendCreate(VU_SEND_TYPE sc)
    {
        share_.flags_.breakdown_.sendCreate_ = sc;
    }

    VuFlagBits Flags() const
    {
        return share_.flags_.breakdown_;
    }
    ushort FlagValue() const
    {
        return share_.flags_.value_;
    }
    VU_ID OwnerId() const
    {
        return share_.ownerId_;
    }
    VU_MEM VuState() const
    {
        return vuState_;
    }
    ushort Type() const
    ...
    SM_SCALAR XDelta() const
    {
        return pos_.dx_;
    }
    SM_SCALAR YDelta() const
    {
        return pos_.dy_;
    }
    SM_SCALAR ZDelta() const
    {
        return pos_.dz_;
    }
    SM_SCALAR Yaw() const
    ...
    SM_SCALAR Pitch() const
    {
        return orient_.pitch_;
    }
    SM_SCALAR Roll() const
    {
        return orient_.roll_;
    }
    SM_SCALAR YawDelta() const
    {
        return orient_.dyaw_;
    }
    SM_SCALAR PitchDelta() const
    {
        return orient_.dpitch_;
    }
    SM_SCALAR RollDelta() const
    {
        return orient_.droll_;
    }

    VU_TIME UpdateRate() const
    {
        return entityTypePtr_->updateRate_;
    }
    VU_TIME LastUpdateTime() const
    {
        return lastUpdateTime_;
    }
    VU_TIME LastTransmissionTime() const
    {
        return lastTransmissionTime_;
    }
    VU_TIME LastCollisionCheckTime() const
    {
        return lastCollisionCheckTime_;
    }
    ...
    {
        return enqueuedForPositionUpdate;
    }
    /** sets if unit is enqueued for a positional update. */
    void SetEnqueuedForPositionUpdate(bool val)
    {
...
protected:
    ...
    void SetId(VU_ID_NUMBER newId)
    {
        share_.id_.num_ = newId;
    }
    void SetVuState(VU_MEM newState)
    {
        vuState_ = newState;
    }
