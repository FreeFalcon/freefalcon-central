...
// COBRA - RED - The Frame List pointer
...
// COBRA - RED - The Play List Pointer
// Tis Class is used to keep track of a series of items, to be selcted randomly
...
ParticleTextureNode *DrawableParticleSys::GetFramesList(char *fn, int Frames)
{
	...
	for(int a=0; a<Frames; a++)	{													// for each Frame
		...
		*List=&GetTextureNode(Name)->texture; List++;									// Each Pointer is Updated
	}
